      ...
      <section className="bg-white rounded-2xl shadow-xl border border-emerald-100 p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm uppercase tracking-wide text-emerald-700 font-semibold">Telemetría rápida</p>
              <h2 className="text-xl font-extrabold text-gray-900">Supabase + app</h2>
              <p className="text-sm text-gray-600 mt-1">
                Ping ligero, timestamp y conteo de pedidos. Complementa el historial operativo de arriba.
              </p>
            </div>
          </div>
          <button
