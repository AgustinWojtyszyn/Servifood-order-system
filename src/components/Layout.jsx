  ...
  return (
    <RequireUser user={user} loading={loading}>
      ...
      <button
        ...
        className="fixed left-4 bottom-4 z-30 inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/25 bg-slate-950/80 text-white shadow-xl shadow-slate-950/30 backdrop-blur md:hidden"
