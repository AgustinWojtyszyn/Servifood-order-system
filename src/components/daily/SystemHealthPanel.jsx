...
const IncidentCard = ({ incident }) => {
  ...
  return (
    <article className={`rounded-xl border p-3 ${toneClasses[tone] || toneClasses.warning}`}>
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div className="flex min-w-0 items-start gap-2">
          <Icon className="mt-0.5 h-4 w-4 shrink-0" />
          <div className="min-w-0">
            <p className="text-sm font-black">{incident?.title || 'Incidente del sistema'}</p>
        ...
        <span className="rounded-full border border-current/20 px-2 py-0.5 text-[11px] font-black uppercase tracking-wide">
      ...
      {incident?.resolution && (
        <p className="mt-2 rounded-lg bg-white/50 px-2 py-1.5 text-xs font-semibold">
        ...
        <div className="mt-4 space-y-4 border-t border-slate-100 pt-4">
          <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
              ...
              <p className="mt-1 text-lg font-black text-slate-950">{recentIncidents.length}</p>
            </div>
          </div>
